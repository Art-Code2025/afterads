...
const BrandStorySection: React.FC = () => {
  return (
    <section className="bg-dark-900 py-16 relative overflow-hidden">
      ...
      <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-dark-400 rounded-full filter blur-3xl opacity-20 animate-float" />
      <div className="absolute -top-10 -left-10 w-56 h-56 bg-dark-500 rounded-full filter blur-3xl opacity-20 animate-float" />
      ...
      <div className="container-responsive grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative order-1 md:order-2 animate-fade-in">
          <img
            ...
            className="rounded-responsive shadow-dark-lg w-full h-auto object-cover"
          />
          <span className="absolute inset-0 bg-gradient-to-br from-transparent to-dark-700 rounded-responsive pointer-events-none" />
        </div>
      </div>
    </section>
  );
